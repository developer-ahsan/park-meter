package com.parkmeter.og.customviews;
...
public class TerminalOnlineIndicator extends View implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
    ...
    public void setNetworkStatus(NetworkStatus networkStatus) {
        ...
        switch(networkStatus) {
            case UNKNOWN:
                contentDescription = LiteralsHelper.getText(getContext(), "a11y_terminal_unknown");
                break;
            case OFFLINE:
                contentDescription = LiteralsHelper.getText(getContext(), "a11y_terminal_offline");
                break;
            case ONLINE:
            default:
                contentDescription = LiteralsHelper.getText(getContext(), "a11y_terminal_online");
                break;
        }
