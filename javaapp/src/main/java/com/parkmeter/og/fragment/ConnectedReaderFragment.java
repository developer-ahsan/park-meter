...
import com.parkmeter.og.TerminalOfflineListener;
import com.parkmeter.og.customviews.TerminalOnlineIndicator;
...
public class ConnectedReaderFragment extends Fragment implements OfflineListener {
    ...
    @NotNull public static final String TAG = "com.parkmeter.og.fragment.ConnectedReaderFragment";
    ...
    public View onCreateView(
        ...
        if (connectedReader != null) {
            ...
            final String description = LiteralsHelper.getText(getContext(), "reader_description").replace("%1$s", connectedReader.getDeviceType().name()).replace("%2$s", connectedReader.getSerialNumber());
